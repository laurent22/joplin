	...
	static metadata() {
		...
		this.metadata_ = {
			...
			'editor': { value: '', type: Setting.TYPE_STRING, public: true, appTypes: ['cli', 'desktop'], label: () => _('Text editor command'), description: () => 
				shim.isWindows() ? 
				_('The editor that will be used to open a note. Use quotes like \"C:\\Program Files\\Edit.exe\" if the path contains spaces. If none is provided it will try to auto-detect the default editor.') : 
