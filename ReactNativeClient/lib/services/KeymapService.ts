...
const defaultKeymapItems = {
	darwin: [
		...
		{ accelerator: null, command: 'newFolder' },
		{ accelerator: null, command: 'newSubFolder' },
		{ accelerator: 'Cmd+S', command: 'synchronize' },
		{ accelerator: null, command: 'print' },
		{ accelerator: 'Shift+Cmd+E', command: 'exportPdf' },
		...
		{ accelerator: 'Shift+Cmd+Y', command: 'textMark' },
	...
	default: [
		...
		{ accelerator: null, command: 'print' },
		{ accelerator: 'Ctrl+Shift+E', command: 'exportPdf' },
		...
		{ accelerator: 'Ctrl+Shift+Y', command: 'textMark' },
