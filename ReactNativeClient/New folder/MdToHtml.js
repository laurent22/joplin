...
const rules = {
	...
	video: require('./MdToHtml/rules/markdown-embed-video/index'),
};
...
class MdToHtml {
	...
	async render(body, style = null, options = null) {
		...
		//    markdownIt.use(rules.imagePlugin(context, ruleOptions));
		//
		...
		if (this.pluginEnabled('video')) markdownIt.use(rules.video, {});
