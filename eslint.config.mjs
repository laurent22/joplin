...
import seiyabEslintPluginReactHooks from "@seiyab/eslint-plugin-react-hooks";
...
const ignoreFile = includeIgnoreFile(
  join(import.meta.dirname, ".ignore.eslint"),
);
    ...
    rules: {
      ...
      "@typescript-eslint/naming-convention": [
        ...
        },
        {
          ...
          filter: {
            regex:
              "^(GET|POST|PUT|DELETE|PATCH|HEAD|SQLite|PostgreSQL|ASC|DESC|E2EE|OR|AND|UNION|INTERSECT|EXCLUSION|INCLUSION|EUR|GBP|USD|SJCL.*|iOS)$",
            match: true,
          },
        },
        {
          ...
          filter: {
            regex:
              "^(sha1|sha256|sha384|sha512|AES_128_GCM|AES_192_GCM|AES_256_GCM)$",
            match: true,
          },
        },
