...
class HeaderComponent extends React.Component {
	...
	makeSearch(key, style, options, state) {
		...
		const usageLink = !this.state.showSearchUsageLink ? null : React.createElement(
			'a',
			{ onClick: this.searchUsageLink_click, style: theme.urlStyle, href: '#' },
			_('Usage')
		);

		return React.createElement(
			'div',
			{ key: key, style: containerStyle },
			React.createElement('input', { type: 'text', style: inputStyle, placeholder: options.title, value: state.searchQuery, onChange: this.search_onChange, ref: elem => this.searchElement_ = elem, onFocus: this.search_onFocus, onBlur: this.search_onBlur, onKeyDown: this.search_keyDown }),
			React.createElement(
				'a',
				{ href: '#', style: searchButton, onClick: this.search_onClear },
				icon
			),
			usageLink
		);
