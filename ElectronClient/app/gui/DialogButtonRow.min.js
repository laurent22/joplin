...
function DialogButtonRow(props) {
	...
	if (props.okButtonShow !== false) {
		buttonComps.push(React.createElement(
			'button',
			{ key: 'ok', style: theme.buttonStyle, onClick: okButton_click, ref: props.okButtonRef, onKeyDown: onKeyDown },
			_('OK')
		));
	}
	...
	if (props.cancelButtonShow !== false) {
		buttonComps.push(React.createElement(
			'button',
			{ key: 'cancel', style: Object.assign({}, theme.buttonStyle, { marginLeft: 10 }), onClick: cancelButton_click },
