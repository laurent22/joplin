	...
	render() {
		...
		function renderSectionTitleHtml(key, title) {
			return React.createElement(
				'h2',
				{ key: `section_${key}`, style: theme.h2Style },
				title
			);
		}
			...
			for (let n in section.body) {
				...
				if (typeof item === 'object') {
					if (item.canRetry) {
						...
						retryLink = React.createElement(
							'a',
							{ href: '#', onClick: onClick, style: retryStyle },
							_('Retry')
						);
					}
					text = item.text;
				...
				itemsHtml.push(React.createElement(
					'div',
					{ style: theme.textStyle, key: `item_${n}` },
					React.createElement(
						'span',
						null,
						text
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					'a',
					{ style: theme.textStyle, onClick: () => this.exportDebugReportClick(), href: '#' },
					'Export debug report'
				),
				body
			)
