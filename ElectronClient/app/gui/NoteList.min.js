...
class NoteListComponent extends React.Component {
	...
	itemRenderer(item) {
		...
		if (highlightedWords.length) {
			...
			titleComp = React.createElement('span', { dangerouslySetInnerHTML: { __html: titleElement.outerHTML } });
		} else {
			titleComp = React.createElement(
				'span',
				null,
				displayTitle
			);
		...
		const watchedIcon = this.props.watchedNoteFiles.indexOf(item.id) < 0 ? null : React.createElement('i', { style: watchedIconStyle, className: 'fa fa-external-link' });
	...
	render() {
		...
		return React.createElement(ItemList, { ref: this.itemListRef, itemHeight: this.style().listItem.height, className: 'note-list', items: notes, style: style, itemRenderer: this.itemRenderer, onKeyDown: this.onKeyDown });
	}
}
