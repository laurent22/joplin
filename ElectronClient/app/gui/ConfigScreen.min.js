...
class ConfigScreenComponent extends React.Component {
	...
	screenFromName(screenName) {
		if (screenName === 'encryption') return React.createElement(EncryptionConfigScreen, { theme: this.props.theme });
		if (screenName === 'server') return React.createElement(ClipperConfigScreen, { theme: this.props.theme });
	...
	sectionToComponent(key, section, settings, selected) {
		...
		const noteComp = section.name !== 'general' ? null : React.createElement(
			'div',
			{ style: Object.assign({}, theme.textStyle, { marginBottom: 10 }) },
		...
		if (section.name === 'sync') {
			...
			if (syncTargetMd.supportsConfigCheck) {
				...
				const statusComp = !messages.length ? null : React.createElement(
					'div',
					{ style: statusStyle },
					messages[0],
					messages.length >= 1 ? React.createElement(
						'p',
						null,
						messages[1]
					) : null
				...
				settingComps.push(React.createElement(
					'div',
					{ key: 'check_sync_config_button', style: this.rowStyle_ },
					React.createElement(
						'button',
						{ disabled: this.state.checkSyncConfigResult === 'checking', style: theme.buttonStyle, onClick: this.checkSyncConfig_ },
			...
			if (syncTargetMd.name === 'nextcloud') {
				...
				const statusComp = !errorMessage || this.state.checkNextcloudAppResult === 'checking' || !this.state.showNextcloudAppLog ? null : React.createElement(
					'div',
					{ style: statusStyle },
					React.createElement(
						'p',
				...
				const showLogButton = !errorMessage || this.state.showNextcloudAppLog ? null : React.createElement(
					'a',
					{ style: theme.urlStyle, href: '#', onClick: this.showLogButton_click },
					'[',
					_('Show Log'),
					']'
				);
				...
				settingComps.push(React.createElement(
					'div',
					{ key: 'nextcloud_app_check', style: this.rowStyle_ },
					React.createElement(
						'span',
						{ style: theme.textStyle },
						'Beta: ',
						_('Joplin Nextcloud App status:'),
						' '
					),
					React.createElement(
						'span',
					...
					React.createElement(
						'button',
						{ disabled: this.state.checkNextcloudAppResult === 'checking', style: theme.buttonStyle, onClick: this.checkNextcloudAppButton_click },
						_('Check Status')
					),
					'\xA0\xA0',
					React.createElement(
						'a',
						{ style: theme.urlStyle, href: '#', onClick: this.nextcloudAppHelpLink_click },
						'[',
						_('Help'),
						']'
					),
		...
		if (advancedSettingComps.length) {
			...
			advancedSettingsButton = React.createElement(
				'button',
				{ onClick: () => shared.advancedSettingsButton_click(this), style: advancedSettingsButtonStyle },
				React.createElement('i', { style: { fontSize: 14 }, className: iconName }),
				' ',
	...
	settingToComponent(key, value) {
		...
		const descriptionComp = descriptionText ? React.createElement(
			'div',
		...
		if (md.isEnum) {
			...
			for (let i = 0; i < array.length; i++) {
				...
				items.push(React.createElement(
					'option',
					{ value: e.key.toString(), key: e.key },
			...
			return React.createElement(
				'div',
				{ key: key + value.toString(), style: rowStyle },
				React.createElement(
					'div',
					{ style: controlStyle },
				...
				return React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								'div',
								{ style: { display: 'flex', flexDirection: 'row', alignItems: 'center', marginBottom: inputStyle.marginBottom } },
								React.createElement('input', {
									type: inputType,
								...
								React.createElement(
									'button',
									{ onClick: browseButtonClick, style: Object.assign({}, theme.buttonStyle, { marginLeft: 5 }) },
									_('Browse...')
								)
							),
							React.createElement('input', {
			...
			return React.createElement(
				...
				React.createElement(
					'button',
					{ style: buttonStyle, onClick: md.onClick },
					_('Edit')
				),
				descriptionComp
			);
	...
	render() {
		...
		const screenComp = this.state.screenName ? React.createElement(
			'div',
		...
		return React.createElement(
			'div',
			{ style: style },
			React.createElement(ConfigMenuBar, {
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement('i', { style: theme.buttonIconStyle, className: 'fa fa-chevron-left' }),
					hasChanges && !screenComp ? _('Cancel') : _('Back')
				),
				!screenComp && React.createElement(
					'div',
					null,
					React.createElement(
						'button',
						{ disabled: !hasChanges, onClick: () => {
								this.onSaveClick();
