...
class MainScreenComponent extends React.Component {
					...
					onClose: async answer => {
						if (answer !== null) {
							...
							if (command.noteIds.length === 1) {
								...
								const startTagTitles = startTags.map(a => {
									return a.label.trim();
								});
			...
			this.setState({
				modalLayer: {
					...
					message: React.createElement(
						...
						React.createElement('div', { id: 'loading-animation' }),
						React.createElement(
							'div',
							{ className: 'text' },
							command.message
	...
	render() {
		...
		if (messageBoxVisible) {
			...
			messageComp = React.createElement(
				'div',
		...
		const pluginDialog = !dialogInfo ? null : React.createElement(dialogInfo.Dialog, dialogInfo.props);
		...
		return React.createElement(
			...
			notePropertiesDialogOptions.visible && React.createElement(NotePropertiesDialog, { theme: this.props.theme, noteId: notePropertiesDialogOptions.noteId, onClose: this.notePropertiesDialog_close, onRevisionLinkClick: notePropertiesDialogOptions.onRevisionLinkClick }),
			shareNoteDialogOptions.visible && React.createElement(ShareNoteDialog, { theme: this.props.theme, noteIds: shareNoteDialogOptions.noteIds, onClose: this.shareNoteDialog_close }),
			React.createElement(PromptDialog, { autocomplete: promptOptions && 'autocomplete' in promptOptions ? promptOptions.autocomplete : null, defaultValue: promptOptions && promptOptions.value ? promptOptions.value : '', theme: this.props.theme, style: styles.prompt, onClose: this.promptOnClose_, label: promptOptions ? promptOptions.label : '', description: promptOptions ? promptOptions.description : null, visible: !!this.state.promptOptions, buttons: promptOptions && 'buttons' in promptOptions ? promptOptions.buttons : null, inputType: promptOptions && 'inputType' in promptOptions ? promptOptions.inputType : null }),
			React.createElement(Header, { style: styles.header, showBackButton: false, items: headerItems }),
			messageComp,
			React.createElement(SideBar, { style: styles.sideBar }),
			React.createElement(VerticalResizer, { style: styles.verticalResizer, onDrag: this.sidebar_onDrag }),
			React.createElement(NoteList, { style: styles.noteList }),
			React.createElement(VerticalResizer, { style: styles.verticalResizer, onDrag: this.noteList_onDrag }),
			React.createElement(NoteText, { style: styles.noteText, keyboardMode: keyboardMode, visiblePanes: this.props.noteVisiblePanes }),
			pluginDialog
		);
	}
}
