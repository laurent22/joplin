...
export type ReturnsPromises<Type> = {
	// eslint-disable-next-line @typescript-eslint/no-explicit-any -- Structural constraint cannot express "args extend SerializableData[]" without forcing index-signature errors at call sites
