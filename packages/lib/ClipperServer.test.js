...
const ClipperServer_1 = require("./ClipperServer");
describe('ClipperServer', () => {
    test.each([
        ...
        expect((0, ClipperServer_1.isPairingPath)(pathname)).toBe(expected);
    });
    test.each([
        ...
        expect((0, ClipperServer_1.isAllowedPairingOrigin)(origin)).toBe(expected);
    });
});
//# sourceMappingURL=ClipperServer.test.js.map