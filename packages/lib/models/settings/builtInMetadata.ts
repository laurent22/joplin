...
const builtInMetadata = (Setting: typeof SettingType) => {
	...
	const output = {
		...
		'ui.sideMenuSwipeWidth': {
			...
			description: () => _('Width of the screen edge area that triggers the side menu (25-200px).'),
			minimum: 25,
			maximum: 200,
			step: 5,
			storage: SettingStorage.File,
		...
		'ui.sideMenuSwipeVelocityThreshold': {
			...
			appTypes: [AppType.Mobile],
			section: 'appearance',
			label: () => _('Side menu swipe velocity threshold'),
			description: () => _('Minimum swipe speed to trigger the side menu (px/s).'),
			minimum: 100,
			maximum: 2000,
			step: 50,
			storage: SettingStorage.File,
		...
		'ui.sideMenuSwipeDistanceThreshold': {
			...
			appTypes: [AppType.Mobile],
			section: 'appearance',
			label: () => _('Side menu swipe distance threshold'),
			description: () => _('Minimum swipe distance to trigger the side menu (px).'),
			minimum: 20,
			maximum: 300,
			step: 10,
			storage: SettingStorage.File,
		...
		'ui.disableRightSideMenuGestures': {
			value: false,
			type: SettingItemType.Bool,
			public: true,
			appTypes: [AppType.Mobile],
			section: 'appearance',
			label: () => _('Disable right side menu gestures'),
			description: () => _('Disable swipe gesture for the note formatting menu.'),
			storage: SettingStorage.File,
			isGlobal: true,
		},
