...
class Setting extends BaseModel {
	...
	static metadata(): SettingItems {
		...
		this.metadata_ = {
			...
			'sync.mobileWifiOnly.reachabilityUrl': {
				value: 'https://joplinapp.org/',
				type: SettingItemType.String,
				section: 'sync',
				public: false,
				// label: () => _('WiFi connection test URL'),
				// description: () => _('The URL to test if WiFi or cellular data is used. Only used on platforms which do not supply internet reachability natively.'),
				storage: SettingStorage.File,
				appTypes: [AppType.Mobile],
			},
