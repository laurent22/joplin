	...
	public static metadata(): SettingItems {
		...
		this.buildInMetadata_ = {
			...
			'editor.usePlainText': {
				...
				label: () => _('Use the plain text editor'),
				description: () => _('The plain text editor has various issues and is no longer supported. If you are having issues with the new editor however you can revert to the old one using this setting.'),
				storage: SettingStorage.File,
				isGlobal: true,
			},
			...
			'autoUploadCrashDumps': {
				...
				public: true,
				appTypes: [AppType.Desktop],
				label: () => _('Automatically upload crash reports'),
				description: () => _('If you experience a crash, please enable this option to automatically send crash reports. You will need to restart the application for this change to take effect.'),
				isGlobal: true,
				storage: SettingStorage.File,
			},
			...
			'editor.beta': {
				...
				description: () => _('This beta adds improved accessibility and plugin API compatibility with the mobile editor. If you find bugs, please report them in the Discourse forum.'),
				storage: SettingStorage.File,
				isGlobal: true,
			},
			...
			'security.biometricsEnabled': {
				...
				description: () => _('Important: This is a beta feature and it is not compatible with certain devices. If the app no longer starts after enabling this or is very slow to start, please uninstall and reinstall the app.'),
				public: true,
				appTypes: [AppType.Mobile],
			},
