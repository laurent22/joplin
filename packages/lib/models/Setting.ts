	...
	static metadata(): SettingItems {
		...
		this.metadata_ = {
			...
			'sync.proxyUrl': {
				...
				public: true,
				label: () => _('Proxy URL'),
				description: () => _('This can be set here or via http_proxy/https_proxy env var'),
				storage: SettingStorage.File,
			},
			'sync.proxyTimeout': {
				value: 1,
				...
				description: () => _('(Seconds) How long should be spent making a connection to the proxy'),
				storage: SettingStorage.File,
			},
