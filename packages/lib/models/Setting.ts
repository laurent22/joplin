...
class Setting extends BaseModel {
	...
	static metadata(): SettingItems {
		...
		this.metadata_ = {
			...
			'markdown.plugin.media': { value: false, type: SettingItemType.Bool, section: 'markdownPlugins', public: true, appTypes: ['desktop'], label: () => `${_('Display supported attachments types inline')}${wysiwygNo}` },
