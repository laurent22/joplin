...
const iso639_1to2 = (iso639_1: string) => {
	const line = iso639Map_.find(l => l[1] === iso639_1);
	if (!line) throw new Error(`Invalid ISO 639-1 code: ${iso639_1}`);
	return line[0];
};
...
export { _, _n, iso639_1to2, supportedLocales, languageName, currentLocale, localesFromLanguageCode, languageCodeOnly, countryDisplayName, localeStrings, setLocale, supportedLocalesToLanguages, defaultLocale, closestSupportedLocale, languageCode, countryCodeOnly };
