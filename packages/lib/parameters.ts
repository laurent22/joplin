...
interface Parameters {
	oneDrive?: ParameterGroup;
	oneDriveDemo?: ParameterGroup;
	oneDriveTest?: ParameterGroup;
	dropbox?: ParameterGroup;
}

const parameters_: Record<string, Parameters> = {};
...
let envOverride_: string | null = null;
export function setEnvOverride(env: string | null) {
	envOverride_ = env;
}

export function parameters(env: string | null = null): Parameters {
