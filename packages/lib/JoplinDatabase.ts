		...
		if (!this.tableDescriptions_) {
			this.tableDescriptions_ = {
				notes: {
					...
					todo_due: sp('When the todo is due. An alarm will be triggered on that date. Will be set to 0 when is_todo is set to 0.'),
					todo_completed: sp('Tells whether todo is completed or not. This is a timestamp in milliseconds. Will be set to 0 when is_todo is set to 0.'),
