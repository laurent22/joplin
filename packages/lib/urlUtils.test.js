...
describe('urlUtils', function() {
	it('should detect URIs', (async () => {
		const testCases = [
			['http://example.com', true],
			['https://example.com', true],
			['http://example.com/jmp/?id=123&u=http://something.com/test', true],
			['https://example.com/jmp/?id=123&u=http://something.com/test', true],
			['http://localhost:3000/', true],
			['file:///c|/WINDOWS/clock.avi', true],
			['http://chart.apis.google.com/chart?chs=500x500&chma=0,0,100,100&cht=p&chco=FF0000%2CFFFF00%7CFF8000%2C00FF00%7C00FF00%2C0000FF&chd=t%3A122%2C42%2C17%2C10%2C8%2C7%2C7%2C7%2C7%2C6%2C6%2C6%2C6%2C5%2C5&chl=122%7C42%7C17%7C10%7C8%7C7%7C7%7C7%7C7%7C6%7C6%7C6%7C6%7C5%7C5', true],
			['this is plain-text', false],
			['http: // this is a broken link', false],
			['http://somewhereelse.com/testing.html', true],
			['http://api.com/алматы/events', true],
		];

		for (const t of testCases) {
			const result = urlUtils.isUri(t[0]);
			const expected = t[1];
