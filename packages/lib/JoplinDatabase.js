...
class JoplinDatabase extends database_1.default {
    ...
    open(options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            yield _super.open.call(this, options);
    ...
    clearForTesting() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.transactionExecBatch(queries);
        });
    }
    createDefaultRow() {
        const row = {};
            ...
            while (currentVersionIndex < existingDatabaseVersions.length - 1) {
                ...
                try {
                    ...
                    if (saveVersionAgain) {
                        ...
                        yield this.transactionExecBatch([updateVersionQuery]);
                    }
                }
    ...
    ftsEnabled() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.selectOne('SELECT count(*) FROM notes_fts');
            }
            catch (error) {
    ...
    fuzzySearchEnabled() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.selectOne('SELECT count(*) FROM notes_spellfix');
            }
            catch (error) {
    ...
    initialize() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                versionRow = yield this.selectOne('SELECT * FROM version LIMIT 1');
            }
            catch (error) {
            ...
            const newVersion = yield this.upgradeDatabase(version);
            ...
            if (newVersion !== tableFieldsVersion)
                yield this.refreshTableFields(newVersion);
            this.tableFields_ = {};
            const rows = yield this.selectAll('SELECT * FROM table_fields');
...
//# sourceMappingURL=JoplinDatabase.js.map