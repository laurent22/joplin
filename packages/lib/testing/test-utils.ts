...
const DatabaseDriverNode = require('../database-driver-node').default;
...
const SyncTargetMemory = require('../SyncTargetMemory').default;
import SyncTargetFilesystem from '../SyncTargetFilesystem';
const SyncTargetNextcloud = require('../SyncTargetNextcloud').default;
const SyncTargetDropbox = require('../SyncTargetDropbox').default;
const SyncTargetAmazonS3 = require('../SyncTargetAmazonS3').default;
const SyncTargetWebDAV = require('../SyncTargetWebDAV').default;
...
const DropboxApi = require('../DropboxApi').default;
