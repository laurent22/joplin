...
exports.stringByLocale = exports.currentLocale = exports.toIso639Alpha3 = void 0;
exports._ = _;
exports._n = _n;
...
const iso639InfoFromAlpha2 = (alpha2) => {
...
function languageName(canonicalName, defaultToEnglish = true) {
...
const toIso639Alpha3 = (code) => {
    ...
    if (!info)
        throw new Error(`Cannot convert to ISO-639 code: ${code}`);
    return info.alpha3;
};
exports.toIso639Alpha3 = toIso639Alpha3;
// eslint-disable-next-line @typescript-eslint/no-explicit-any -- Old code before rule was applied
function _(s, ...args) {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any -- Old code before rule was applied
const stringByLocale = (locale, s, ...args) => {
...
exports.stringByLocale = stringByLocale;
