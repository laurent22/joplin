...
const locationFilter = (terms, conditions, params, relation, useFts) => {
...
const dateFilter = (terms, conditions, params, relation, useFts) => {
...
const sourceUrlFilter = (terms, conditions, params, relation, useFts) => {
