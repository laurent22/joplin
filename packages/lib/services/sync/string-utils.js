...
exports.stripBom = exports.replaceRegexDiacritics = exports.pregQuote = void 0;
exports.removeDiacritics = removeDiacritics;
exports.escapeRegExp = escapeRegExp;
exports.wrap = wrap;
exports.commandArgumentsToString = commandArgumentsToString;
exports.splitCommandBatch = splitCommandBatch;
exports.padLeft = padLeft;
exports.toTitleCase = toTitleCase;
exports.urlDecode = urlDecode;
exports.escapeHtml = escapeHtml;
exports.surroundKeywords = surroundKeywords;
exports.substrWithEllipsis = substrWithEllipsis;
exports.nextWhitespaceIndex = nextWhitespaceIndex;
...
exports.pregQuote = stringUtilsCommon.pregQuote;
exports.replaceRegexDiacritics = stringUtilsCommon.replaceRegexDiacritics;
...
function formatCssSize(v) {
    if (typeof v === 'string') {
        if (v.includes('px') || v.includes('em') || v.includes('%'))
            return v;
    }
    return `${v}px`;
}
...
function scriptType(s) {
    ...
    if (REGEX_CHINESE.test(s))
        return 'zh';
    if (REGEX_JAPANESE.test(s))
        return 'ja';
    if (REGEX_KOREAN.test(s))
        return 'ko';
    if (REGEX_THAI.test(s))
        return 'th';
    return 'en';
}
