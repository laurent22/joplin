...
async function ip() {
    const response = await shim_1.default.fetch('https://api.ipify.org/?format=json');
    if (!response.ok) {
...
async function findAvailablePort(tcpPortUsed, possiblePorts, extraRandomPortsToTry = 20) {
