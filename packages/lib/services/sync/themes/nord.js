...
const theme = Object.assign(Object.assign({}, dark_1.default), { backgroundColor: nord[0], backgroundColorTransparent: 'rgba(46, 52, 64, 0.9)', oddBackgroundColor: nord[1], color: nord[5], colorError: nord[11], colorWarn: nord[12], colorFaded: nord[4], dividerColor: nord[10], selectedColor: nord[9], urlColor: nord[8], backgroundColor2: nord[2], color2: nord[8], selectedColor2: nord[10], colorError2: nord[11], raisedBackgroundColor: nord[2], raisedColor: nord[7], warningBackgroundColor: nord[13], tableBackgroundColor: nord[0], codeBackgroundColor: nord[0], codeBorderColor: nord[2], codeColor: nord[13], codeMirrorTheme: 'nord', codeThemeCss: 'atom-one-dark-reasonable.css' });
