...
type ListRendererDatabaseDependency = 'folder.created_time' | 'folder.created_time.display' | 'folder.deleted_time' | 'folder.deleted_time.display' | 'folder.encryption_applied' | 'folder.encryption_applied.display' | 'folder.encryption_cipher_text' | 'folder.encryption_cipher_text.display' | 'folder.icon' | 'folder.icon.display' | 'folder.id' | 'folder.id.display' | 'folder.is_shared' | 'folder.is_shared.display' | 'folder.master_key_id' | 'folder.master_key_id.display' | 'folder.parent_id' | 'folder.parent_id.display' | 'folder.share_id' | 'folder.share_id.display' | 'folder.title' | 'folder.title.display' | 'folder.updated_time' | 'folder.updated_time.display' | 'folder.user_created_time' | 'folder.user_created_time.display' | 'folder.user_data' | 'folder.user_data.display' | 'folder.user_updated_time' | 'folder.user_updated_time.display' | 'folder.type_' | 'folder.type_.display' | 'note.altitude' | 'note.altitude.display' | 'note.application_data' | 'note.application_data.display' | 'note.author' | 'note.author.display' | 'note.body' | 'note.body.display' | 'note.conflict_original_id' | 'note.conflict_original_id.display' | 'note.created_time' | 'note.created_time.display' | 'note.deleted_time' | 'note.deleted_time.display' | 'note.encryption_applied' | 'note.encryption_applied.display' | 'note.encryption_cipher_text' | 'note.encryption_cipher_text.display' | 'note.id' | 'note.id.display' | 'note.is_conflict' | 'note.is_conflict.display' | 'note.is_shared' | 'note.is_shared.display' | 'note.is_todo' | 'note.is_todo.display' | 'note.latitude' | 'note.latitude.display' | 'note.longitude' | 'note.longitude.display' | 'note.markup_language' | 'note.markup_language.display' | 'note.master_key_id' | 'note.master_key_id.display' | 'note.order' | 'note.order.display' | 'note.parent_id' | 'note.parent_id.display' | 'note.share_id' | 'note.share_id.display' | 'note.source' | 'note.source.display' | 'note.source_application' | 'note.source_application.display' | 'note.source_url' | 'note.source_url.display' | 'note.title' | 'note.title.display' | 'note.todo_completed' | 'note.todo_completed.display' | 'note.todo_due' | 'note.todo_due.display' | 'note.updated_time' | 'note.updated_time.display' | 'note.user_created_time' | 'note.user_created_time.display' | 'note.user_data' | 'note.user_data.display' | 'note.user_updated_time' | 'note.user_updated_time.display' | 'note.type_' | 'note.type_.display';
// AUTO-GENERATED by generate-database-type

export const columnNames = ['note.latitude', 'note.longitude', 'note.source_url', 'note.title', 'note.todo_completed', 'note.todo_due', 'note.user_created_time', 'note.user_updated_time'];
