...
const pluginCategoriesOptions: pluginCategory = {
	...
	'Insert Date': ['editor'],
	'Note Variables': ['editor'],
	'Paste Special': ['editor'],
	'Table Formatter Plugin': ['editor'],
	'BibTeX': ['integrations'],
	...
	'Code Section': ['editor'],
	'Folding in Code Mirror Editor': ['editor', 'appearance'],
	'Agenda': ['productivity'],
