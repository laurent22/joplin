...
const defaultKeymapItems = {
	darwin: [
		...
		{ accelerator: 'Cmd+Home', command: 'editor.goDocStart' },
		{ accelerator: 'Cmd+End', command: 'editor.goDocEnd' },
		{ accelerator: 'Cmd+Left', command: 'editor.goGroupLeft' },
		{ accelerator: 'Cmd+Right', command: 'editor.goGroupRight' },
		{ accelerator: 'Alt+Left', command: 'editor.goLineStart' },
		{ accelerator: 'Alt+Right', command: 'editor.goLineEnd' },
		{ accelerator: 'Alt+Backspace', command: 'editor.delGroupBefore' },
		{ accelerator: 'Alt+Delete', command: 'editor.delGroupAfter' },
	...
	default: [
		...
		{ accelerator: 'Ctrl+Home',	command: 'editor.goDocStart' },
		{ accelerator: 'Ctrl+End', command: 'editor.goDocEnd' },
		{ accelerator: 'Ctrl+Left', command: 'editor.goGroupLeft' },
		{ accelerator: 'Ctrl+Right', command: 'editor.goGroupRight' },
		{ accelerator: 'Alt+Left', command: 'editor.goLineStart' },
		{ accelerator: 'Alt+Right', command: 'editor.goLineEnd' },
		{ accelerator: 'Ctrl+Backspace', command: 'editor.delGroupBefore' },
		{ accelerator: 'Ctrl+Delete', command: 'editor.delGroupAfter' },
