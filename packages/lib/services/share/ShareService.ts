...
export default class ShareService {
	...
	public async checkShareConsistency() {
		...
		console.info('CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC');
		console.info('shares', shares);
		console.info('rootSharedFolders', rootSharedFolders);
		...
		for (const folder of rootSharedFolders) {
			...
			if (!share) {
				...
				await this.leaveSharedFolder(folder.id, share.user.id);
			}
		}
	}
