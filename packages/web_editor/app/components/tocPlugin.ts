...
export function insertToc(editor: any): void {
  ...
  const tocHtml =
    `<div id="${baseId}" class="mce-toc" data-joplin-toc="1" style="border:1px solid #ccc;border-radius:4px;padding:12px 16px;background:#f9f9f9;margin-bottom:1em;">` +
...
export function updateToc(editor: any): void {
  ...
  const tocDivs = doc.querySelectorAll('div.mce-toc');
