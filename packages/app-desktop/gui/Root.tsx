...
class RootComponent extends React.Component<Props, any> {
	...
	public render() {
		...
		const screens = {
			...
			JoplinCloudLogin: { screen: JoplinCloudLoginScreen, title: () => _('Cloud Sync Login') },
			JoplinServerSamlLogin: { screen: SsoLoginScreen(new SamlShared()), title: () => _('Cloud Server Login') },
