		...
		<div className='conflict-title'>
			...
			<div className='-subheader'>
				<div className='-instructions'>
					...
					<div className='-instructions-detail'>{_('You\'re reviewing changes between your copy of this note and the latest synced version. Some changes may have been merged automatically.')}</div>
				</div>
