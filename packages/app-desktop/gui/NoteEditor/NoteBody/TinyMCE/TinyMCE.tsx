		...
		const loadEditor = async () => {
			...
			const editors = await containerWindow.tinymce.init({
                ...
                internalDraggedImage.outerHTML;
							...
							const removableWrapperTags = ['P', 'DIV', 'H1', 'H2', 'H3', 'H4', 'H5', 'H6'];

							if (
								originalParent &&
								originalParent !== editor.getBody() &&
								originalParent.id !== 'rendered-md' &&
								removableWrapperTags.includes(originalParent.nodeName) &&
