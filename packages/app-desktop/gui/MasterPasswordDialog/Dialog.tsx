		...
		if (showPasswordForm) {
			...
			return (
				<div>
					...
					<p className="bold">{_('Please make sure you remember your master password. For security reasons it cannot be recovered if lost, and any data encrypted with it will become inaccessible.')}</p>
