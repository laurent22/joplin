...
// eslint-disable-next-line @typescript-eslint/no-explicit-any -- custom controls have varied prop shapes
const settingKeyToControl: Record<string, any> = {
	'plugins.states': control_PluginsStates,
	'globalHotkey': GlobalHotkeyInput,
};
