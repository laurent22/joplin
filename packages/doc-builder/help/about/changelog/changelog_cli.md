---
sidebar_label: "Joplin terminal app changelog"
---
...
- New: Add additional time format [HH.mm](http://HH.mm) (#6086 by [@vincentjocodes](https://github.com/vincentjocodes))
...
IMPORTANT: If you use the web API, please note that there are a few breaking changes in this release. See here for more information: [https://github.com/laurent22/joplin/pull/3983#issue-509624899](https://github.com/laurent22/joplin/pull/3983#issue-509624899)
...
- Fixed: Handle WebDAV servers that do not return a last modified date (fixes [mail.ru](http://mail.ru)) (#2091)
