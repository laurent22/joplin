---
sidebar_label: "Joplin iOS app changelog"
---
...
- Improved: Ping [joplinapp.org](http://joplinapp.org) domain instead of Google when doing the WiFi connection check (#5705)
