...
interface Props {
	...
	textCompContainerStyle: ViewStyle;
...
// text wrapping, depending on whether the text is wide enough to require a toggle. Note that there may be a small amount of over-approximation when updating
// 'multiline' (which can be mapped to the driving component's multiline prop). This causes the toggle to appear only after wrapping has begun, avoiding early
// expansion and improving the editing experience.
