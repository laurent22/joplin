...
import UndoRedoService from '@joplinapp/lib/services/UndoRedoService';
import uuid from '@joplinapp/lib/uuid';
...
// const { MarkdownEditor } = require('@joplinapp/lib/../MarkdownEditor/index.js');
...
const { fileExtension, safeFileExtension } = require('@joplinapp/lib/path-utils');
