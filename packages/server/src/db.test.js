...
describe('db', () => {
    ...
    it('should allow upgrading and downgrading schema', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should tell if a migration is required', () => __awaiter(void 0, void 0, void 0, function* () {
        expect(yield (0, db_1.needsMigration)((0, testUtils_1.db)())).toBe(true);
        yield (0, db_1.migrateLatest)((0, testUtils_1.db)());
        expect(yield (0, db_1.needsMigration)((0, testUtils_1.db)())).toBe(false);
    }));
});
