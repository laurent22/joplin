...
describe('admin/users', () => {
    ...
    test('should create a user with null properties if they are not explicitly set', () => __awaiter(void 0, void 0, void 0, function* () {
        const { session } = yield (0, testUtils_1.createUserAndSession)(1, true);
    ...
    test('should ask user to set password if not set on creation', () => __awaiter(void 0, void 0, void 0, function* () {
        const { session } = yield (0, testUtils_1.createUserAndSession)(1, true);
        yield postUser(session.id, 'test@example.com', '', {
            max_item_size: '',
        });
    ...
    test('should format the email when saving it', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should not create anything if user creation fail', () => __awaiter(void 0, void 0, void 0, function* () {
        const { session } = yield (0, testUtils_1.createUserAndSession)(1, true);
        const userModel = (0, testUtils_1.models)().user();
        const password = (0, uuidgen_1.default)();
        yield postUser(session.id, 'test@example.com', password);
    ...
    test('should list users', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should delete sessions when changing password', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should apply ACL', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, testUtils_1.expectHttpError)(() => __awaiter(void 0, void 0, void 0, function* () { return patchUser(adminSession.id, { id: admin.id, is_admin: 0 }); }), errors_1.ErrorForbidden.httpCode);
        // cannot delete own user
        yield (0, testUtils_1.expectHttpError)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, apiUtils_1.execRequest)(adminSession.id, 'POST', `admin/users/${admin.id}`, { disable_button: true }); }), errors_1.ErrorForbidden.httpCode);
    }));
});
