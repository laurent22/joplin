...
describe('users/impersonate', () => {
    ...
    test('should impersonate a user', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should not impersonate if not admin', () => __awaiter(void 0, void 0, void 0, function* () {
        const ctx = yield (0, testUtils_1.koaAppContext)();
        ...
        yield (0, testUtils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, impersonate_1.startImpersonating)(ctx, adminUser.id); }));
    }));
