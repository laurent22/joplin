...
describe('api/items', () => {
    beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, testUtils_1.beforeAllDb)('api/items');
    }));
    ...
    test('should create an item', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should modify an item', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should delete an item', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user, session } = yield (0, testUtils_1.createUserAndSession)(1, true);
        const tree = {
    ...
    test('should delete all items', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should get back the serialized note', () => __awaiter(void 0, void 0, void 0, function* () {
        const { session } = yield (0, testUtils_1.createUserAndSession)(1, true);
        const noteId = '00000000000000000000000000000001';
        const filename = `${noteId}.md`;
    ...
    test('should get back the item metadata', () => __awaiter(void 0, void 0, void 0, function* () {
        const { session } = yield (0, testUtils_1.createUserAndSession)(1, true);
        const noteId = '00000000000000000000000000000001';
    ...
    test('should batch upload items', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should report errors when batch uploading', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should list children', () => __awaiter(void 0, void 0, void 0, function* () {
        const { session } = yield (0, testUtils_1.createUserAndSession)(1, true);
        const itemNames = [
            '.resource/r1',
            'locks/1.json',
    ...
    test('should associate a resource blob with a share', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should not upload or download items if the account is disabled', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, testUtils_1.expectHttpError)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, testUtils_1.createItem)(session.id, 'root:/test2.txt:', 'test2'); }), errors_1.ErrorForbidden.httpCode);
        yield (0, testUtils_1.expectHttpError)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, testUtils_1.getItem)(session.id, 'root:/test1.txt:'); }), errors_1.ErrorForbidden.httpCode);
    }));
    test('should check permissions - only share participants can associate an item with a share', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, testUtils_1.expectHttpError)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, apiUtils_1.putApi)(session3.id, 'items/root:/.resource/000000000000000000000000000000E1:/content', {}, { query: { share_id: share.id } }); }), errors_1.ErrorForbidden.httpCode);
    }));
    test('should check permissions - uploaded item should be below the allowed limit', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1, session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
        {
        ...
        }
        {
            ...
            yield (0, testUtils_1.expectNoHttpError)(() => __awaiter(void 0, void 0, void 0, function* () {
                return (0, testUtils_1.createNote)(session1.id, {
    ...
    test('should check permissions - uploaded item should not make the account go over the allowed max limit', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1, session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
        {
    ...
    test('should check permissions - should not allow uploading items if disabled', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1, session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
