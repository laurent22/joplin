...
describe('share_users', () => {
    ...
    test('should list user invitations', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should not change someone else shareUser object', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1, session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const { user: user2, session: session2 } = yield (0, testUtils_1.createUserAndSession)(2);
        ...
        yield (0, testUtils_1.expectHttpError)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, apiUtils_1.patchApi)(session1.id, `share_users/${shareUser.id}`, { status: types_1.ShareUserStatus.Accepted }); }), errors_1.ErrorForbidden.httpCode);
    }));
    test('should not allow accepting a share twice or more', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, testUtils_1.expectHttpError)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, apiUtils_1.patchApi)(session2.id, `share_users/${shareUser.id}`, { status: types_1.ShareUserStatus.Accepted }); }), errors_1.ErrorBadRequest.httpCode);
    }));
});
