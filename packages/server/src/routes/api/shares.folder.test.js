...
describe('shares.folder', () => {
    ...
    test('should share a folder with another user', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should share a folder and all its children', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should received shared items only once invitation accepted', () => __awaiter(void 0, void 0, void 0, function* () {
        const { session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const { session: session2 } = yield (0, testUtils_1.createUserAndSession)(2);
    ...
    test('should share when a note is added to a shared folder', () => __awaiter(void 0, void 0, void 0, function* () {
        const { session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const { user: user2, session: session2 } = yield (0, testUtils_1.createUserAndSession)(2);
    ...
    test('should update share status when note parent changes', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1, session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const { user: user2, session: session2 } = yield (0, testUtils_1.createUserAndSession)(2);
    ...
    test('should update share status when note parent changes more than once between updates', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1, session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const { user: user2, session: session2 } = yield (0, testUtils_1.createUserAndSession)(2);
    ...
    test('should not throw an error if an item is associated with a share that no longer exists', () => __awaiter(void 0, void 0, void 0, function* () {
        const { session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const { session: session2 } = yield (0, testUtils_1.createUserAndSession)(2);
        ...
        yield (0, testUtils_1.expectNotThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return yield (0, testUtils_1.models)().share().updateSharedItems3(); }));
    }));
    test('should not throw an error if a change is associated with an item that no longer exists', () => __awaiter(void 0, void 0, void 0, function* () {
        const { session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const { session: session2 } = yield (0, testUtils_1.createUserAndSession)(2);
        const { share: share1 } = yield (0, shareApiUtils_1.shareFolderWithUser)(session1.id, session2.id, '000000000000000000000000000000F1', {
            '000000000000000000000000000000F1': {},
        });
        const { share: share2 } = yield (0, shareApiUtils_1.shareFolderWithUser)(session1.id, session2.id, '000000000000000000000000000000F2', {
            '000000000000000000000000000000F2': {},
        });
        const item1 = yield (0, testUtils_1.createNote)(session1.id, {
            id: '00000000000000000000000000000007',
            share_id: share1.id,
        });
        yield (0, testUtils_1.createNote)(session1.id, {
        ...
        yield (0, testUtils_1.models)().item().delete(item1.id);
        yield (0, testUtils_1.models)().share().updateSharedItems3();
        yield (0, testUtils_1.expectNotThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return yield (0, testUtils_1.models)().share().updateSharedItems3(); }));
    }));
    test('should not throw an error if a user no longer has a user item, and the target share changes', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1, session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const { user: user2, session: session2 } = yield (0, testUtils_1.createUserAndSession)(2);
        yield (0, shareApiUtils_1.shareFolderWithUser)(session1.id, session2.id, '000000000000000000000000000000F1', [
            {
        ...
        yield (0, testUtils_1.models)().userItem().deleteByUserItem(user2.id, noteItem.id, { recordChanges: false });
        yield (0, testUtils_1.expectNotThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return yield (0, testUtils_1.models)().share().updateSharedItems3(); }));
    }));
    test('should unshare a deleted item', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1, session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const { user: user2, session: session2 } = yield (0, testUtils_1.createUserAndSession)(2);
        yield (0, shareApiUtils_1.shareFolderWithUser)(session1.id, session2.id, '000000000000000000000000000000F1', {
            '000000000000000000000000000000F1': {
    ...
    test('should unshare a deleted shared root folder', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1, session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const { user: user2, session: session2 } = yield (0, testUtils_1.createUserAndSession)(2);
        yield (0, shareApiUtils_1.shareFolderWithUser)(session1.id, session2.id, '000000000000000000000000000000F1', {
            '000000000000000000000000000000F1': {
    ...
    test('should unshare when the share object is deleted', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1, session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const { user: user2, session: session2 } = yield (0, testUtils_1.createUserAndSession)(2);
        yield (0, shareApiUtils_1.shareFolderWithUser)(session1.id, session2.id, '000000000000000000000000000000F1', {
            '000000000000000000000000000000F1': {
    ...
    // });
    test('should see delta changes for linked items', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1, session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const { session: session2 } = yield (0, testUtils_1.createUserAndSession)(2);
        yield (0, shareApiUtils_1.shareFolderWithUser)(session1.id, session2.id, '000000000000000000000000000000F1', {
            '000000000000000000000000000000F1': {
    ...
    test('should get delta changes - user 2 sync, user 1 share and sync, user 2 sync', () => __awaiter(void 0, void 0, void 0, function* () {
        // - User 1 sync
    ...
    test('should get delta changes - user 1 and 2 are in sync, user 2 adds a note to shared folder', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1, session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const { session: session2 } = yield (0, testUtils_1.createUserAndSession)(2);
        const { share } = yield (0, shareApiUtils_1.shareFolderWithUser)(session1.id, session2.id, '000000000000000000000000000000F1', {
            '000000000000000000000000000000F1': {
    ...
    test('should get delta changes - user 1 and 2 are in sync, user 2 moves a note out of shared folder', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1, session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const { session: session2 } = yield (0, testUtils_1.createUserAndSession)(2);
        yield (0, shareApiUtils_1.shareFolderWithUser)(session1.id, session2.id, '000000000000000000000000000000F1', {
            '000000000000000000000000000000F1': {
    ...
    test('should get delta changes - user 1 and 2 are in sync, user 1 deletes invitation', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1, session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const { user: user2, session: session2 } = yield (0, testUtils_1.createUserAndSession)(2);
    ...
    test('should share an empty folder', () => __awaiter(void 0, void 0, void 0, function* () {
        const { session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const { session: session2 } = yield (0, testUtils_1.createUserAndSession)(2);
        yield (0, shareApiUtils_1.shareFolderWithUser)(session1.id, session2.id, '000000000000000000000000000000F1', [
            {
    ...
    test('should unshare from a non-owner user who has deleted the root folder', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1, session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const { user: user2, session: session2 } = yield (0, testUtils_1.createUserAndSession)(2);
    ...
    test('should unshare a folder', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // });
    test('should check permissions - cannot share a folder with yourself', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1, session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
        ...
        yield (0, testUtils_1.expectHttpError)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, apiUtils_1.postApi)(session1.id, `shares/${share.id}/users`, { email: user1.email }); }), errors_1.ErrorForbidden.httpCode);
    }));
    test('should check permissions - cannot share a folder twice with a user', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1, session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
        ...
        yield (0, testUtils_1.expectHttpError)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, apiUtils_1.postApi)(session1.id, `shares/${share.id}/users`, { email: user2.email }); }), errors_1.ErrorForbidden.httpCode);
    }));
    test('should check permissions - cannot share a non-root folder', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1, session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
        ...
        yield (0, testUtils_1.expectHttpError)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, apiUtils_1.postApi)(session1.id, 'shares', { folder_id: '000000000000000000000000000000F2' }); }), errors_1.ErrorForbidden.httpCode);
    }));
    test('should check permissions - cannot share if share feature not enabled', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1, session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const { session: session2 } = yield (0, testUtils_1.createUserAndSession)(2);
        yield (0, testUtils_1.models)().user().save({ id: user1.id, can_share_folder: 0 });
        yield (0, testUtils_1.expectHttpError)(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should check permissions - cannot share if share feature not enabled for recipient', () => __awaiter(void 0, void 0, void 0, function* () {
        const { session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const { user: user2, session: session2 } = yield (0, testUtils_1.createUserAndSession)(2);
        yield (0, testUtils_1.models)().user().save({ id: user2.id, can_receive_folder: 0 });
        yield (0, testUtils_1.expectHttpError)(() => __awaiter(void 0, void 0, void 0, function* () {
            return (0, shareApiUtils_1.shareFolderWithUser)(session1.id, session2.id, '000000000000000000000000000000F1', [
                {
                    id: '000000000000000000000000000000F1',
    ...
    test('should check permissions - by default sharing by note is always possible', () => __awaiter(void 0, void 0, void 0, function* () {
        const { session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
    ...
    test('should check permissions - cannot share with a disabled account', () => __awaiter(void 0, void 0, void 0, function* () {
        const { session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const { user: user2, session: session2 } = yield (0, testUtils_1.createUserAndSession)(2);
    ...
    test('should allow sharing, unsharing and sharing again', () => __awaiter(void 0, void 0, void 0, function* () {
