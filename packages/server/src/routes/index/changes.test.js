...
describe('index_changes', () => {
    beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, testUtils_1.beforeAllDb)('index_changes');
    }));
    ...
    test('should list changes', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        {
            const response = yield (0, apiUtils_1.execRequest)(session1.id, 'GET', 'changes');
        ...
        {
            const response = yield (0, apiUtils_1.execRequest)(session1.id, 'GET', 'changes', null, { query: { page: 2 } });
            const navLinks = (0, testUtils_1.parseHtml)(response).querySelectorAll('.pagination-link');
