...
const getHandlers = {
    ...
    checkoutTest: (_stripe, _path, ctx) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const basicPrice = (0, joplinCloud_1.findPrice)((0, stripe_1.stripeConfig)(), { accountType: 1, period: joplinCloud_1.PricePeriod.Monthly });
        const proPrice = (0, joplinCloud_1.findPrice)((0, stripe_1.stripeConfig)(), { accountType: 2, period: joplinCloud_1.PricePeriod.Monthly });
