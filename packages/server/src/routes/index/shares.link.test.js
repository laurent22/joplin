...
describe('shares.link', () => {
    ...
    test('should display a simple note', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should load plugins', () => __awaiter(void 0, void 0, void 0, function* () {
        const { session } = yield (0, testUtils_1.createUserAndSession)();
        const noteItem = yield (0, testUtils_1.createNote)(session.id, {
    ...
    test('should render attached images', () => __awaiter(void 0, void 0, void 0, function* () {
        const { session } = yield (0, testUtils_1.createUserAndSession)();
        const noteItem = yield (0, testUtils_1.createNote)(session.id, {
    ...
    test('should share a linked note', () => __awaiter(void 0, void 0, void 0, function* () {
        const { session } = yield (0, testUtils_1.createUserAndSession)();
    ...
    test('should not share items that are not linked to a shared note', () => __awaiter(void 0, void 0, void 0, function* () {
        const { session } = yield (0, testUtils_1.createUserAndSession)();
        ...
        yield (0, testUtils_1.expectNotThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return getShareContent(share.id, { note_id: '00000000000000000000000000000001' }); }));
        yield (0, testUtils_1.expectHttpError)(() => __awaiter(void 0, void 0, void 0, function* () { return getShareContent(share.id, { note_id: '000000000000000000000000000000C5' }); }), errors_1.ErrorNotFound.httpCode);
        yield (0, testUtils_1.expectHttpError)(() => __awaiter(void 0, void 0, void 0, function* () { return getShareContent(share.id, { note_id: '000000000000000000000000000000E2' }); }), errors_1.ErrorNotFound.httpCode);
    }));
    test('should not share linked notes if the "recursive" field is not set', () => __awaiter(void 0, void 0, void 0, function* () {
        const { session } = yield (0, testUtils_1.createUserAndSession)();
        const linkedNote1 = yield (0, testUtils_1.createNote)(session.id, {
            id: '000000000000000000000000000000C1',
        });
        ...
        yield (0, testUtils_1.expectHttpError)(() => __awaiter(void 0, void 0, void 0, function* () { return getShareContent(share.id, { note_id: '000000000000000000000000000000C1' }); }), errors_1.ErrorForbidden.httpCode);
    }));
    test('should not throw an error if the note contains links to non-existing items', () => __awaiter(void 0, void 0, void 0, function* () {
        const { session } = yield (0, testUtils_1.createUserAndSession)();
        {
            const noteItem = yield (0, testUtils_1.createNote)(session.id, {
                id: '00000000000000000000000000000001',
            ...
            yield (0, testUtils_1.expectNotThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return getShareContent(share.id); }));
        }
        {
            const noteItem = yield (0, testUtils_1.createNote)(session.id, {
    ...
    test('should throw an error if owner of share is disabled', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, testUtils_1.expectHttpError)(() => __awaiter(void 0, void 0, void 0, function* () { return getShareContent(share.id); }), errors_1.ErrorForbidden.httpCode);
    }));
});
