...
describe('index/users', () => {
    ...
    test('new user should be able to login', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should change user properties', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should change the password', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should get a user', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should allow user to set a password for new accounts', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should not confirm email if not requested', () => __awaiter(void 0, void 0, void 0, function* () {
        let user1 = yield (0, testUtils_1.models)().user().save({
            email: 'user1@localhost',
            must_set_password: 1,
            email_confirmed: 0,
    ...
    test('should allow user to verify their email', () => __awaiter(void 0, void 0, void 0, function* () {
        let user1 = yield (0, testUtils_1.models)().user().save({
            email: 'user1@localhost',
            must_set_password: 0,
            email_confirmed: 0,
    ...
    test('should allow changing an email', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user, session } = yield (0, testUtils_1.createUserAndSession)();
        ...
        yield (0, testUtils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, apiUtils_1.execRequest)('', 'GET', path, null, { query: { token } }); }));
    }));
    test('should not change non-whitelisted properties', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should apply ACL', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, testUtils_1.expectHttpError)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, apiUtils_1.execRequest)(session1.id, 'GET', 'admin/users'); }), errors_1.ErrorForbidden.httpCode);
        // non-admin user cannot view another user
        yield (0, testUtils_1.expectHttpError)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, apiUtils_1.execRequest)(session1.id, 'GET', `users/${admin.id}`); }), errors_1.ErrorForbidden.httpCode);
        // non-admin user cannot create a new user
        yield (0, testUtils_1.expectHttpError)(() => __awaiter(void 0, void 0, void 0, function* () { return postUser(session1.id, 'cantdothat@example.com'); }), errors_1.ErrorForbidden.httpCode);
        // non-admin user cannot update another user
        yield (0, testUtils_1.expectHttpError)(() => __awaiter(void 0, void 0, void 0, function* () { return patchUser(session1.id, { id: admin.id, email: 'cantdothateither@example.com' }); }), errors_1.ErrorForbidden.httpCode);
    }));
});
