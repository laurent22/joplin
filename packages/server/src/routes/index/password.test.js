...
describe('index/password', () => {
    ...
    test('should queue an email to reset password', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should not queue an email for non-existing emails', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should not reset the password if the token is invalid', () => __awaiter(void 0, void 0, void 0, function* () {
