...
class ShareModel extends BaseModel_1.default {
    get tableName() {
        return 'shares';
    }
                ...
                if (previousShare) {
                    ...
                    for (const shareUserId of shareUserIds) {
                        ...
                        try {
                            ...
                            if (error.httpCode === errors_1.ErrorNotFound.httpCode) {
                        ...
                        for (const change of changes) {
                            ...
                            if (item) {
                                ...
                                if (change.type === types_1.ChangeType.Create) {
                                    yield handleCreated(change, item, itemShare);
                                }
                                if (change.type === types_1.ChangeType.Update) {
                                    yield handleUpdated(change, item, itemShare);
                                }
                            }
    ...
    shareFolder(owner, folderId, masterKeyId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.checkIfAllowed(owner, BaseModel_1.AclAction.Create, shareToSave);
