...
class TaskStateModel extends BaseModel_1.default {
    ...
    start(taskId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (state.running)
                throw new errors_1.ErrorBadRequest(`Task is already running: ${taskId}`, { code: errors_1.ErrorCode.TaskAlreadyRunning });
    ...
    stop(taskId) {
        return __awaiter(this, void 0, void 0, function* () {
            const state = yield this.loadByTaskId(taskId);
            if (!state.running)
                throw new errors_1.ErrorBadRequest(`Task is not running: ${taskId}`, { code: errors_1.ErrorCode.TaskAlreadyRunning });
