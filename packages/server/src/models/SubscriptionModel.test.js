...
describe('SubscriptionModel', () => {
    ...
    test('should create a user and subscription', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should enable and allow the user to upload if a payment is successful', () => __awaiter(void 0, void 0, void 0, function* () {
