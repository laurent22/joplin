...
describe('loadStorageDriver', () => {
    ...
    test('should load a driver and assign an ID to it', () => __awaiter(void 0, void 0, void 0, function* () {
        {
    ...
    test('should not record the same storage connection twice', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, testUtils_1.db)()('storages').insert({
            connection_string: 'Type=Database',
            updated_time: Date.now(),
            created_time: Date.now(),
        });
        yield (0, testUtils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () {
