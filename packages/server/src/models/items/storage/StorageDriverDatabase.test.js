...
describe('StorageDriverDatabase', () => {
    ...
    test('should fail if the item row does not exist', () => __awaiter(void 0, void 0, void 0, function* () {
        const driver = newDriver();
        yield (0, testUtils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return driver.read('oops', { models: (0, testUtils_1.models)() }); }));
    }));
    test('should do nothing if deleting non-existing row', () => __awaiter(void 0, void 0, void 0, function* () {
        const driver = newDriver();
        yield (0, testUtils_1.expectNotThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return driver.delete('oops', { models: (0, testUtils_1.models)() }); }));
    }));
});
