...
describe('StorageDriverFs', () => {
    ...
    test('should write to a file and read it back', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should automatically create the base path', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should not throw if deleting a file that does not exist', () => __awaiter(void 0, void 0, void 0, function* () {
        const driver = newDriver();
        yield (0, testUtils_1.expectNotThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return driver.delete('notthere'); }));
    }));
});
