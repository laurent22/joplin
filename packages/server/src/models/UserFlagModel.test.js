...
describe('UserFlagModel', () => {
    ...
    test('should create no more than one flag per type', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should set the timestamp when disabling an account', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user } = yield (0, testUtils_1.createUserAndSession)(1);
        const beforeTime = Date.now();
        yield (0, testUtils_1.models)().userFlag().add(user.id, types_1.UserFlagType.FailedPaymentFinal);
