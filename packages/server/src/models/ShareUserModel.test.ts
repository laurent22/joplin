...
// 		await shareWithUserAndAccept(session1.id, session3.id, user3, file1a);
// 		await shareWithUserAndAccept(session1.id, session3.id, user3, file1b);
// 		await shareWithUserAndAccept(session2.id, session3.id, user3, file2);
