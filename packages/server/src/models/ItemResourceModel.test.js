...
describe('ItemResourceModel', () => {
    ...
    test('should get an item tree', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should not go into infinite loop when a note links to itself', () => __awaiter(void 0, void 0, void 0, function* () {
        const { session } = yield (0, testUtils_1.createUserAndSession)();
        const rootNote = yield (0, testUtils_1.createNote)(session.id, {
            id: '00000000000000000000000000000001',
