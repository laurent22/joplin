...
describe('ItemModel', () => {
    ...
    // 	}
    // });
    test('should find all items within a shared folder', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should count items', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should calculate the total size', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should update total size when an item is deleted', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1 } = yield (0, testUtils_1.createUserAndSession)(1);
        yield (0, testUtils_1.createItemTree3)(user1.id, '', '', [
            {
                id: '000000000000000000000000000000F1',
    ...
    test('should include shared items in total size calculation', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1, session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
    ...
    test('should respect the hard item size limit', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1 } = yield (0, testUtils_1.createUserAndSession)(1);
        ...
        yield (0, testUtils_1.expectHttpError)(() => __awaiter(void 0, void 0, void 0, function* () { return models.item().loadWithContent(item.id); }), errors_1.ErrorPayloadTooLarge.httpCode);
        (0, config_1.default)().itemSizeHardLimit = 1000;
        models = (0, factory_1.default)((0, testUtils_1.db)(), (0, config_1.default)());
        yield (0, testUtils_1.expectNotThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return models.item().loadWithContent(item.id); }));
    }));
    const setupImportContentTest = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should allow importing content to item storage', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1 } = yield (0, testUtils_1.createUserAndSession)(1);
    ...
    test('should skip large items when importing content to item storage', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const { toStorageConfig, fromModels, fromDriver, toDriver, } = yield setupImportContentTest();
    ...
    test('should delete the database item content', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should delete the database item content - maxProcessedItems handling', () => __awaiter(void 0, void 0, void 0, function* () {
        if ((0, db_1.isSqlite)((0, testUtils_1.db)())) {
            expect(1).toBe(1);
            return;
        }
    ...
    // deleted.
    test('should process orphaned items - 1', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const { user: user2 } = yield (0, testUtils_1.createUserAndSession)(2);
        yield (0, testUtils_1.createItemTree3)(user1.id, '', '', [
            {
        ...
        yield (0, testUtils_1.db)()('users').where('id', '=', user1.id).delete();
        yield (0, testUtils_1.db)()('user_items').where('user_id', '=', user1.id).delete();
        expect(yield (0, testUtils_1.models)().item().count()).toBe(2);
        yield (0, testUtils_1.models)().item().processOrphanedItems();
        expect(yield (0, testUtils_1.models)().item().count()).toBe(1);
        const item = yield (0, testUtils_1.models)().item().all();
    ...
    test('should process orphaned items - 2', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const { user: user2 } = yield (0, testUtils_1.createUserAndSession)(2);
        yield (0, testUtils_1.createItemTree3)(user1.id, '', '', [
            {
        ...
        yield (0, testUtils_1.db)()('user_items').where('user_id', '=', user1.id).delete();
        expect(yield (0, testUtils_1.models)().userItem().count()).toBe(1);
        yield (0, testUtils_1.models)().item().processOrphanedItems();
        expect(yield (0, testUtils_1.models)().item().count()).toBe(2);
        expect(yield (0, testUtils_1.models)().userItem().count()).toBe(2);
        expect((yield (0, testUtils_1.models)().userItem().byUserId(user1.id)).length).toBe(1);
        expect((yield (0, testUtils_1.models)().userItem().byUserId(user2.id)).length).toBe(1);
    }));
});
