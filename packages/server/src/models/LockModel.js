    ...
    acquireSyncLock(userId, clientType, clientId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.models().keyValue().readThenWrite(userKey, (value) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (exclusiveLock) {
                    throw new errors_1.ErrorConflict(`Cannot acquire lock because there is already an exclusive lock for client: ${exclusiveLock.clientType} #${exclusiveLock.clientId}`, errors_1.ErrorCode.HasExclusiveSyncLock);
                }
            ...
            yield this.models().keyValue().readThenWrite(userKey, (value) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (syncLock) {
                    if (syncLock.clientId === clientId) {
                        ...
                        throw new errors_1.ErrorConflict(`Cannot acquire exclusive lock because there is an active sync lock for client: ${syncLock.clientType} #${syncLock.clientId}`, errors_1.ErrorCode.HasSyncLock);
                    }
                }
                output = {
                    id: (0, uuidgen_1.default)(),
