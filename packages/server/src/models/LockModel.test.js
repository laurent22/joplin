...
describe('LockModel', () => {
    ...
    test('should allow exclusive lock if the sync locks have expired', () => __awaiter(void 0, void 0, void 0, function* () {
        jest.useFakeTimers();
        ...
        yield (0, testUtils_1.expectHttpError)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, testUtils_1.models)().lock().acquireLock(user.id, LockHandler_1.LockType.Exclusive, LockHandler_1.LockClientType.Desktop, '3333'); }), errors_1.ErrorConflict.httpCode);
    ...
    test('should keep user locks separated', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, testUtils_1.expectHttpError)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, testUtils_1.models)().lock().acquireLock(user1.id, LockHandler_1.LockType.Exclusive, LockHandler_1.LockClientType.Desktop, '3333'); }), errors_1.ErrorConflict.httpCode);
    ...
    test('should validate locks', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1 } = yield (0, testUtils_1.createUserAndSession)(1);
        yield (0, testUtils_1.expectHttpError)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, testUtils_1.models)().lock().acquireLock(user1.id, 'wrongtype', LockHandler_1.LockClientType.Desktop, '1111'); }), errors_1.ErrorUnprocessableEntity.httpCode);
        yield (0, testUtils_1.expectHttpError)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, testUtils_1.models)().lock().acquireLock(user1.id, LockHandler_1.LockType.Exclusive, 'wrongclienttype', '1111'); }), errors_1.ErrorUnprocessableEntity.httpCode);
        yield (0, testUtils_1.expectHttpError)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, testUtils_1.models)().lock().acquireLock(user1.id, LockHandler_1.LockType.Exclusive, LockHandler_1.LockClientType.Desktop, 'veryverylongclientidveryverylongclientidveryverylongclientidveryverylongclientid'); }), errors_1.ErrorUnprocessableEntity.httpCode);
    }));
    test('should expire locks', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user } = yield (0, testUtils_1.createUserAndSession)(1);
        jest.useFakeTimers();
        const t1 = new Date('2020-01-01').getTime();
        jest.setSystemTime(t1);
