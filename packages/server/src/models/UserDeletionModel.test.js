...
describe('UserDeletionModel', () => {
    ...
    test('should add a deletion operation', () => __awaiter(void 0, void 0, void 0, function* () {
        {
        ...
        }
        {
            ...
            yield (0, testUtils_1.models)().userDeletion().add(user.id, Date.now() + 1000);
            yield (0, testUtils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, testUtils_1.models)().userDeletion().add(user.id, Date.now() + 1000); }));
        }
    }));
    test('should provide the next deletion operation', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should start and stop deletion jobs', () => __awaiter(void 0, void 0, void 0, function* () {
        jest.useFakeTimers();
        const t0 = new Date('2021-12-14').getTime();
        jest.setSystemTime(t0);
        const user1 = yield (0, testUtils_1.createUser)(1);
    ...
    test('should auto-add users for deletion', () => __awaiter(void 0, void 0, void 0, function* () {
        jest.useFakeTimers();
