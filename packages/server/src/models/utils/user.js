...
exports.totalSizeClass = exports.totalSizePercent = exports.getMaxTotalItemSize = exports.getMaxItemSize = exports.getCanReceiveFolder = exports.getCanShareFolder = void 0;
...
function getCanReceiveFolder(user) {
    if (!('account_type' in user) || !('can_receive_folder' in user))
        throw new Error('Missing account_type or can_receive_folder property');
    const account = (0, UserModel_1.accountByType)(user.account_type);
    return user.can_receive_folder !== null ? user.can_receive_folder : account.can_receive_folder;
}
exports.getCanReceiveFolder = getCanReceiveFolder;
