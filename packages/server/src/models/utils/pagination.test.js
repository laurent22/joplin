...
describe('pagination', () => {
    test('should create options from request query parameters', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, testUtils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, pagination_1.requestPagination)({ order_dir: 'ASC' }); }));
        yield (0, testUtils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, pagination_1.requestPagination)({ order_dir: 'DESC' }); }));
        yield (0, testUtils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, pagination_1.requestPagination)({ page: 0 }); }));
    }));
    test('should create page link logic', () => __awaiter(void 0, void 0, void 0, function* () {
