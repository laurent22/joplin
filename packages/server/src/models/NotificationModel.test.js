...
describe('NotificationModel', () => {
    ...
    test('should require a user to create the notification', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, testUtils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, testUtils_1.models)().notification().add('', NotificationModel_1.NotificationKey.EmailConfirmed, types_1.NotificationLevel.Normal, NotificationModel_1.NotificationKey.EmailConfirmed); }));
    }));
    test('should create a notification', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should create only one notification per key', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user } = yield (0, testUtils_1.createUserAndSession)(1, true);
        const model = (0, testUtils_1.models)().notification();
        yield model.add(user.id, NotificationModel_1.NotificationKey.EmailConfirmed, types_1.NotificationLevel.Important, 'testing');
        yield model.add(user.id, NotificationModel_1.NotificationKey.EmailConfirmed, types_1.NotificationLevel.Important, 'testing');
    ...
    test('should mark a notification as read', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user } = yield (0, testUtils_1.createUserAndSession)(1, true);
        const model = (0, testUtils_1.models)().notification();
        yield model.add(user.id, NotificationModel_1.NotificationKey.EmailConfirmed, types_1.NotificationLevel.Important, 'testing');
