...
describe('ChangeModel', () => {
    ...
    test('should track changes - create only', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should track changes - create, then update', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should throw an error if cursor is invalid', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user } = yield (0, testUtils_1.createUserAndSession)(1, true);
        const itemModel = (0, testUtils_1.models)().item();
        const changeModel = (0, testUtils_1.models)().change();
        let i = 1;
        ...
        yield (0, testUtils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return changeModel.delta(user.id, { limit: 1, cursor: 'invalid' }); }), 'resyncRequired');
    }));
    test('should tell that there are more changes even when current page is empty', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should not fail when retrieving many changes', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        let changeCount = 0;
        yield (0, testUtils_1.expectNotThrow)(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should delete old changes', () => __awaiter(void 0, void 0, void 0, function* () {
