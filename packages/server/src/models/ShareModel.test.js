...
describe('ShareModel', () => {
    ...
    test('should validate share objects', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        let error = null;
        error = yield (0, testUtils_1.checkThrowAsync)(() => __awaiter(void 0, void 0, void 0, function* () { return yield (0, testUtils_1.models)().share().createShare(user.id, 20, item.id); }));
        expect(error instanceof errors_1.ErrorBadRequest).toBe(true);
        error = yield (0, testUtils_1.checkThrowAsync)(() => __awaiter(void 0, void 0, void 0, function* () { return yield (0, testUtils_1.models)().share().createShare(user.id, types_1.ShareType.Note, 'doesntexist'); }));
        expect(error instanceof errors_1.ErrorNotFound).toBe(true);
    }));
    test('should get all shares of a user', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should generate only one link per shared note', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should delete a note that has been shared', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1 } = yield (0, testUtils_1.createUserAndSession)(1);
        yield (0, testUtils_1.createItemTree)(user1.id, '', {
            '000000000000000000000000000000F1': {
                '00000000000000000000000000000001': null,
    ...
    test('should count number of items in share', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1, session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
    ...
    test('should count number of items in share per recipient', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1, session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const { user: user2, session: session2 } = yield (0, testUtils_1.createUserAndSession)(2);
    ...
    test('should create user items for shared folder', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, testUtils_1.expectNotThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, testUtils_1.models)().share().createSharedFolderUserItems(share.id, user3.id); }));
