...
const modelLogger = Logger_1.default.create('ItemModel');
class ItemModel extends BaseModel_1.default {
    constructor(db, modelFactory, config) {
        ...
        this.processOrphanedItems = () => __awaiter(this, void 0, void 0, function* () {
            yield this.withTransaction(() => __awaiter(this, void 0, void 0, function* () {
                const orphanedItems = yield this.db(this.tableName)
                    .select(['items.id', 'items.owner_id'])
                    .leftJoin('user_items', 'user_items.item_id', 'items.id')
                    .whereNull('user_items.user_id');
                const userIds = orphanedItems.map(i => i.owner_id);
                const users = yield this.models().user().loadByIds(userIds, { fields: ['id'] });
                for (const orphanedItem of orphanedItems) {
                    if (!users.find(u => u.id)) {
                        ...
                        yield this.delete(orphanedItem.id);
                    }
                    else {
                        // Otherwise we add it back to the user's collection
                        yield this.models().userItem().add(orphanedItem.owner_id, orphanedItem.id);
                    }
                }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            for (let i = 0; i < 10; i++) {
                ...
                try {
                    ...
                    if (error.code === errors_1.CustomErrorCode.NotFound) {
    ...
    saveFromRawContent(user, rawContentItemOrItems, options = null) {
        return __awaiter(this, void 0, void 0, function* () {
            options = options || {};
            ...
            return this.withTransaction(() => __awaiter(this, void 0, void 0, function* () {
                const existingItems = yield this.loadByNames(user.id, rawContentItems.map(i => i.name), { fields: ['id', 'name'] });
    ...
    joplinItemSharedRootInfo(jopId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!path.length)
                throw new errors_1.ApiError(`Cannot retrieve path for item: ${jopId}`, null, errors_1.ErrorCode.NoPathForItem);
            ...
            return this.withTransaction(() => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    if ((0, db_1.isUniqueConstraintError)(error)) {
                        ...
                        throw new errors_1.ErrorConflict(`This item is already present and cannot be added again: ${item.name}`);
                    }
                    else {
                        throw error;
                    }
