...
describe('UserModel', () => {
    ...
    test('should validate user objects', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        let error = null;
        // Email must be set
        error = yield (0, testUtils_1.checkThrowAsync)(() => __awaiter(void 0, void 0, void 0, function* () { return yield (0, testUtils_1.models)().user().save({ email: '', password: '1234546' }); }));
        expect(error instanceof errors_1.ErrorUnprocessableEntity).toBe(true);
        // Password must be set
        error = yield (0, testUtils_1.checkThrowAsync)(() => __awaiter(void 0, void 0, void 0, function* () { return yield (0, testUtils_1.models)().user().save({ email: 'newone@example.com', password: '' }); }));
        expect(error instanceof errors_1.ErrorUnprocessableEntity).toBe(true);
        // email must be set
        error = yield (0, testUtils_1.checkThrowAsync)(() => __awaiter(void 0, void 0, void 0, function* () { return yield (0, testUtils_1.models)().user().save({ id: user1.id, email: '' }); }));
        expect(error instanceof errors_1.ErrorUnprocessableEntity).toBe(true);
        // password must be set
        error = yield (0, testUtils_1.checkThrowAsync)(() => __awaiter(void 0, void 0, void 0, function* () { return yield (0, testUtils_1.models)().user().save({ id: user1.id, password: '' }); }));
        expect(error instanceof errors_1.ErrorUnprocessableEntity).toBe(true);
        // there is already a user with this email
        error = yield (0, testUtils_1.checkThrowAsync)(() => __awaiter(void 0, void 0, void 0, function* () { return yield (0, testUtils_1.models)().user().save({ id: user1.id, email: user2.email }); }));
        expect(error instanceof errors_1.ErrorUnprocessableEntity).toBe(true);
        // check that the email is valid
        error = yield (0, testUtils_1.checkThrowAsync)(() => __awaiter(void 0, void 0, void 0, function* () { return yield (0, testUtils_1.models)().user().save({ id: user1.id, email: 'ohno' }); }));
        expect(error instanceof errors_1.ErrorUnprocessableEntity).toBe(true);
    }));
    ...
    // });
    test('should push an email when creating a new user', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should send a beta reminder email', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should disable beta account once expired', () => __awaiter(void 0, void 0, void 0, function* () {
        (0, stripe_1.stripeConfig)().enabled = true;
        const { user: user1 } = yield (0, testUtils_1.createUserAndSession)(1, false, { email: 'toto@example.com' });
        const range = (0, stripe_1.betaUserDateRange)();
        yield (0, testUtils_1.models)().user().save({
    ...
    test('should disable upload and send an email if payment failed recently', () => __awaiter(void 0, void 0, void 0, function* () {
        (0, stripe_1.stripeConfig)().enabled = true;
    ...
    test('should disable disable the account and send an email if payment failed for good', () => __awaiter(void 0, void 0, void 0, function* () {
        (0, stripe_1.stripeConfig)().enabled = true;
        const { user: user1 } = yield (0, testUtils_1.models)().subscription().saveUserAndSubscription('toto@example.com', 'Toto', UserModel_1.AccountType.Basic, 'usr_111', 'sub_111');
        const sub = yield (0, testUtils_1.models)().subscription().byUserId(user1.id);
        const now = Date.now();
    ...
    test('should send emails and flag accounts when it is over the size limit', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const { user: user2 } = yield (0, testUtils_1.createUserAndSession)(2);
        yield (0, testUtils_1.models)().user().save({
            id: user1.id,
    ...
    test('should get the user public key', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const { user: user2 } = yield (0, testUtils_1.createUserAndSession)(2);
        ...
        yield (0, testUtils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, testUtils_1.models)().user().publicPrivateKey(user4.id); }));
    }));
    test('should remove flag when account goes under the limit', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1 } = yield (0, testUtils_1.createUserAndSession)(1);
        yield (0, testUtils_1.models)().user().save({
            id: user1.id,
            account_type: UserModel_1.AccountType.Basic,
    ...
    test('should disable and enable users', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const { user: user2 } = yield (0, testUtils_1.createUserAndSession)(2);
        jest.useFakeTimers();
    ...
    test('should throw an error if the password being saved seems to be hashed', () => __awaiter(void 0, void 0, void 0, function* () {
        const passwordSimilarToHash = '$2a$10';
        const error = yield (0, testUtils_1.checkThrowAsync)(() => __awaiter(void 0, void 0, void 0, function* () { return yield (0, testUtils_1.models)().user().save({ password: passwordSimilarToHash }); }));
