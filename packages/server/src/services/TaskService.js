...
const taskIdToLabel = (taskId) => {
    const strings = {
        ...
        [types_1.TaskId.ProcessOrphanedItems]: 'Process orphaned items',
        [types_1.TaskId.ProcessShares]: 'Process shared items',
        [types_1.TaskId.ProcessEmails]: 'Process emails',
    };
...
class TaskService extends BaseService_1.default {
    ...
    resetInterruptedTasks() {
        return __awaiter(this, void 0, void 0, function* () {
            const taskStates = yield this.models.taskState().all();
            for (const taskState of taskStates) {
                if (taskState.running) {
                    ...
                    yield this.models.taskState().stop(taskState.task_id);
                }
            }
        });
    }
    ...
    runInBackground() {
        return __awaiter(this, void 0, void 0, function* () {
            for (const [taskId, task] of Object.entries(this.tasks_)) {
                ...
                let interval = null;
                try {
                    interval = (0, time_1.durationToMilliseconds)(task.schedule);
                }
                catch (error) {
                    // Assume that we have a cron schedule
                    interval = null;
                }
                const runTaskWithErrorChecking = (taskId) => __awaiter(this, void 0, void 0, function* () {
                    try {
                        yield this.runTask(taskId, RunType.Scheduled);
                    }
                    catch (error) {
                        if (error.code === errors_1.ErrorCode.TaskAlreadyRunning) {
                ...
                if (interval !== null) {
                    setInterval(() => __awaiter(this, void 0, void 0, function* () {
                        yield runTaskWithErrorChecking(Number(taskId));
                    }), interval);
                }
                else {
