...
describe('services/email/utils', () => {
    test('markdownBodyToHtml should convert URLs to clickable links', () => __awaiter(void 0, void 0, void 0, function* () {
        const testCases = [
    ...
    test('markdownBodyToPlainText should convert links to plain URLs', () => __awaiter(void 0, void 0, void 0, function* () {
        const testCases = [
