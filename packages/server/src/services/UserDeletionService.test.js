...
describe('UserDeletionService', () => {
    ...
    test('should not delete notebooks that are not owned', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should not delete notebooks that are owned', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1, session: session1 } = yield (0, testUtils_1.createUserAndSession)(1);
    ...
    test('should not do anything if the user is still enabled', () => __awaiter(void 0, void 0, void 0, function* () {
        const { user: user1 } = yield (0, testUtils_1.createUserAndSession)(1);
        const t0 = new Date('2021-12-14').getTime();
        const t1 = t0 + 1000;
        const job = yield (0, testUtils_1.models)().userDeletion().add(user1.id, t1, {
