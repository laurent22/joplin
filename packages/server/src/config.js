...
exports.showItemUrls = exports.baseUrl = exports.initConfig = exports.fullVersionString = exports.runningInDocker = void 0;
...
const fullVersionString = (config) => {
    const output = [];
    output.push(`v${config.appVersion}`);
    if (config.appVersion !== config.joplinServerVersion)
        output.push(`(Based on Joplin Server v${config.joplinServerVersion})`);
    return output.join(' ');
};
