...
describe('env', () => {
    ...
    it('should parse env values', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should overrides default values', () => __awaiter(void 0, void 0, void 0, function* () {
        expect((0, env_1.parseEnv)({}).POSTGRES_USER).toBe('joplin');
        expect((0, env_1.parseEnv)({}, { POSTGRES_USER: 'other' }).POSTGRES_USER).toBe('other');
    }));
    it('should validate values', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, testUtils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, env_1.parseEnv)({ POSTGRES_PORT: 'notanumber' }); }));
        yield (0, testUtils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, env_1.parseEnv)({ MAILER_ENABLED: 'TRUE' }); }));
    }));
});
