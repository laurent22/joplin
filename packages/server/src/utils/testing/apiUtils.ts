...
export async function putApiC(sessionId: string, path: string, body: object = null, options: ExecRequestOptions = null): Promise<AppContext> {
	return execApiC(sessionId, 'PUT', path, body, options);
}


export async function putApi<T>(sessionId: string, path: string, body: object = null, options: ExecRequestOptions = null): Promise<T> {
	return execApi<T>(sessionId, 'PUT', path, body, options);
}


export async function patchApiC(sessionId: string, path: string, body: object = null, options: ExecRequestOptions = null): Promise<AppContext> {
	return execApiC(sessionId, 'PATCH', path, body, options);
}


export async function patchApi<T>(sessionId: string, path: string, body: object = null, options: ExecRequestOptions = null): Promise<T> {
...
export async function postApiC(sessionId: string, path: string, body: object = null, options: ExecRequestOptions = null): Promise<AppContext> {
	return execApiC(sessionId, 'POST', path, body, options);
}


export async function postApi<T>(sessionId: string, path: string, body: object = null, options: ExecRequestOptions = null): Promise<T> {
	return execApi<T>(sessionId, 'POST', path, body, options);
}


export async function execRequestC(sessionId: string, method: string, path: string, body: object = null, options: ExecRequestOptions = null): Promise<AppContext> {
	options = options || {};
...
export async function execRequest<T>(sessionId: string, method: string, url: string, body: object = null, options: ExecRequestOptions = null): Promise<T> {
...
export async function execApiC(sessionId: string, method: string, path: string, body: object = null, options: ExecRequestOptions = null): Promise<AppContext> {
	return execRequestC(sessionId, method, `api/${path}`, body, options);
}


export async function execApi<T>(sessionId: string, method: string, url: string, body: object = null, options: ExecRequestOptions = null): Promise<T> {
