...
describe('routeUtils', () => {
    it('should parse a route path', () => __awaiter(void 0, void 0, void 0, function* () {
        const testCases = [
    ...
    it('should find a matching route', () => __awaiter(void 0, void 0, void 0, function* () {
        const testCases = [
            ['/admin/organizations', {
                    route: 1,
        ...
        yield (0, testUtils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, routeUtils_1.findMatchingRoute)('help', routes); }));
        yield (0, testUtils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, routeUtils_1.findMatchingRoute)('api/users/123', routes); }));
    }));
    it('should split an item path', () => __awaiter(void 0, void 0, void 0, function* () {
        const testCases = [
    ...
    it('should check the request origin for API URLs', () => __awaiter(void 0, void 0, void 0, function* () {
        const testCases = [
            [
                'https://example.com',
                'https://example.com',
    ...
    it('should check the request origin for User Content URLs', () => __awaiter(void 0, void 0, void 0, function* () {
        const testCases = [
            [
    ...
    it('should check if a URL matches a schema', () => __awaiter(void 0, void 0, void 0, function* () {
        const testCases = [
            [
