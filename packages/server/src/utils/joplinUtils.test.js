...
describe('joplinUtils', () => {
    it('should check if an item is encrypted', () => __awaiter(void 0, void 0, void 0, function* () {
        const testCases = [
        ...
        yield (0, testUtils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, joplinUtils_1.itemIsEncrypted)({ name: 'missing props' }); }));
    }));
});
