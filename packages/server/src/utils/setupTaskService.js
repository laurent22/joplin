...
function default_1(env, models, config, services) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let tasks = [
            ...
            {
                id: types_1.TaskId.ProcessOrphanedItems,
                description: (0, TaskService_1.taskIdToLabel)(types_1.TaskId.ProcessOrphanedItems),
                schedule: '15 * * * *',
                run: (models) => models.item().processOrphanedItems(),
            },
            {
                id: types_1.TaskId.ProcessShares,
                description: (0, TaskService_1.taskIdToLabel)(types_1.TaskId.ProcessShares),
                schedule: 'PT10S',
                run: (models) => models.share().updateSharedItems3(),
            },
            {
                id: types_1.TaskId.ProcessEmails,
                description: (0, TaskService_1.taskIdToLabel)(types_1.TaskId.ProcessEmails),
                schedule: '* * * * *',
                run: (_models, services) => services.email.runMaintenance(),
            },
        ];
        ...
        yield taskService.resetInterruptedTasks();
        return taskService;
    });
}
