...
})(RouteResponseFormat || (exports.RouteResponseFormat = RouteResponseFormat = {}));
var ResponseType;
...
function execRequest(routes, ctx) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (ctx.URL && !isValidOrigin(ctx.URL.origin, (0, config_1.baseUrl)(endPoint.type), endPoint.type))
            throw new errors_1.ErrorNotFound(`Invalid origin: ${ctx.URL.origin}`, errors_1.ErrorCode.InvalidOrigin);
