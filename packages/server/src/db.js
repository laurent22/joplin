...
// fine as numbers.
require('pg').types.setTypeParser(20, (val) => {
...
const needsMigration = (db) => __awaiter(void 0, void 0, void 0, function* () {
...
function truncateTables(db, includedTables = []) {
    return __awaiter(this, void 0, void 0, function* () {
        for (const tableName of allTableNames()) {
            if (includedTables.length && !includedTables.includes(tableName))
                continue;
            try {
