...
function default_1(view) {
    if (view.expireDays <= 0) {
        return {
            subject: `Your ${(0, config_1.default)().appName} beta account is expired`,
            body: `

Your ${(0, config_1.default)().appName} beta account is expired.
...
If you have any question please contact support at ${(0, config_1.default)().supportEmail}.
...
`.trim(),
        ...
        return {
            subject: `Your ${(0, config_1.default)().appName} beta account will expire in ${view.expireDays} days`,
            body: `

Your ${(0, config_1.default)().appName} beta account will expire in ${view.expireDays} days.
