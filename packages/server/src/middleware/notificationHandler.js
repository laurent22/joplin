...
function handleConfirmEmailNotification(ctx) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!ctx.joplin.owner.email_confirmed) {
            return {
                id: 'confirmEmail',
                messageHtml: (0, renderMarkdown_1.default)(`An email has been sent to you containing an activation link to complete your registration. If you did not receive it, you may send it again from [your profile page](${(0, urlUtils_1.profileUrl)()}).\n\nMake sure you click it to secure your account and keep access to it.`),
                levelClassName: levelClassName(types_1.NotificationLevel.Important),
                closeUrl: '',
            };
        }
