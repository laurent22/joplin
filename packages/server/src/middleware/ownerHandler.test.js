...
describe('ownerHandler', () => {
    ...
    test('should login user with valid session ID', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should not login user with invalid session ID', () => __awaiter(void 0, void 0, void 0, function* () {
