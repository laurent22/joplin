...
describe('notificationHandler', () => {
    ...
    test('should check admin password', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should not check admin password for non-admin', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should display a banner if the account is disabled', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should display a banner if the email is not confirmed', () => __awaiter(void 0, void 0, void 0, function* () {
        const { session, user } = yield (0, testUtils_1.createUserAndSession)(1);
        {
            const ctx = yield runNotificationHandler(session.id);
