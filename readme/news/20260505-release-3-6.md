---
forum_url: https://discourse.joplinapp.org/
---
...
![Joplin Markdown editor with in-editor rendering enabled, showing styled headings, bold/italic text and inline images while the underlying Markdown is still being typed.](https://raw.githubusercontent.com/laurent22/joplin/dev/Assets/WebsiteAssets/images/news/20260505-markdown-rendering.png)
...
![A Joplin note with an embedded YouTube video player rendered directly inside the note.](https://raw.githubusercontent.com/laurent22/joplin/dev/Assets/WebsiteAssets/images/news/20260505-youtube-embed.png)
...
![A note imported from OneNote, showing handwritten ink, attachments and formatting correctly preserved in Joplin.](https://raw.githubusercontent.com/laurent22/joplin/dev/Assets/WebsiteAssets/images/news/20260505-onenote-import.png)
...
![Joplin desktop sidebar showing the new sync status icon and the collapsible sync report.](https://raw.githubusercontent.com/laurent22/joplin/dev/Assets/WebsiteAssets/images/news/20260505-sync-status.png)
...
- **Ctrl/Cmd + mouse wheel** now zooms the interface in and out.
...
- Keyboard shortcuts have been added to toolbar buttons.
- **Copy** and **Select All** now work in the note viewer and in read-only mode.
...
![Joplin note list in detailed view showing the percentage completion indicator on notes that contain checkbox lists.](https://raw.githubusercontent.com/laurent22/joplin/dev/Assets/WebsiteAssets/images/news/20260505-checkbox-percentage.png)
...
It is now possible to set a custom sort order for each notebook on mobile, matching the behaviour that has long been available on desktop. This is particularly useful when different notebooks need different sorting (e.g. a journal sorted by date, a reference notebook sorted alphabetically).

![Joplin mobile notebook sort options dialog showing a per-notebook sort selection.](https://raw.githubusercontent.com/laurent22/joplin/dev/Assets/WebsiteAssets/images/news/20260505-mobile-notebook-sort.png)

### A dedicated attachments management screen

A new screen lists all attachments associated with a note, making it much easier to review, open or remember what is attached, especially for notes that have grown over time.

![Joplin mobile attachments management screen listing the files attached to a note.](https://raw.githubusercontent.com/laurent22/joplin/dev/Assets/WebsiteAssets/images/news/20260505-mobile-attachments.png)
...
![Joplin mobile toolbar customization screen with up and down arrows used to reorder buttons.](https://raw.githubusercontent.com/laurent22/joplin/dev/Assets/WebsiteAssets/images/news/20260505-mobile-toolbar.png)

### Other mobile improvements

A few additional changes worth mentioning:

- Joplin now **remembers whether you were viewing or editing** each note, instead of always reopening in the same mode.
...
- A bug that caused **characters to disappear while typing** in the Android Markdown editor has been fixed.

## Bug fixes and security fixes across platforms

Joplin 3.6 also includes a large number of bug fixes across desktop and mobile, addressing issues in editing, syncing, importing, rendering and general stability. Several security-related improvements have also been made, including a stronger Content Security Policy on desktop and an updated `tar` library used during imports.
