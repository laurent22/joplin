...
<!-- SCREENSHOT: Go To Anything showing semantic search results where the matching notes don't contain the literal search terms -->
...
<!-- SCREENSHOT: The share notebook dialog showing the email autocomplete suggestions -->
