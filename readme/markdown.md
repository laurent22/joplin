...
| **Link** | <pre>This is detected as a link:<br><br>`https://joplinapp.org`<br><br>And this is a link anchoring some text content:<br><br>`[Joplin](https://joplinapp.org)`<br><br>And this is a link, with a title, anchoring some<br>text content:<br><br>`[Joplin](https://joplinapp.org "Joplin project page")`</pre> | This is detected as a link:<br><br>https://joplinapp.org<br><br>And this is a link, with a title, anchoring some text content:<br><br>[Joplin](https://joplinapp.org)<br><br>And this is a link anchoring some text content, but also includes a title:<br><br>[Joplin](https://joplinapp.org "Joplin project page") (_hint: hover over the link_)
