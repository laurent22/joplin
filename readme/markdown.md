...
| **Verbatim text** | <pre>Indent with a tab or 4 spaces<br>for verbatim text.<br/><br/>    This text will be rendered as is:<br><br>    Robert'); DROP TABLE students;--</pre> | Indent with a tab or 4 spaces for verbatim text.<br><br><pre>This text will be rendered as is:<br><br>Robert'); DROP TABLE students;--</pre>
