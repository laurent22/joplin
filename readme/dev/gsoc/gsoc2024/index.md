...
- [How to submit a pull request for GSoC](https://joplinapp.org/help/dev/gsoc/gsoc2024/pull_request_guidelines/)
...
Before submitting a pull request, please make sure you read the [pull request guidelines for GSoC 2024](https://joplinapp.org/help/dev/gsoc/gsoc2024/pull_request_guidelines/).
...
3. Take a look at the [list of ideas](https://github.com/laurent22/joplin/blob/dev/readme/dev/gsoc/gsoc2024/ideas.md). You can have you own idea added by posting it in the [Features category](https://discourse.joplinapp.org/c/features)
...
https://joplinapp.org/help/dev/gsoc/gsoc2024/ideas/
